...
European Summer of Code is a paid stipend programme, through May-September 2026.
...
- April 1, 18:00 (UTC). Applications via the ESoC application form open.
- April 1, 18:00 (UTC). Applications via the GC.OS application form open.
- April 30, 18:00 (UTC). First stage. You must complete the ESoC application, and the GC.OS application form by this deadline.
- May 14. We inform you of the first stage outcome (proceed to interview) *latest* by may 14, but hopefully sooner.
- May 18 to May 29. Second stage. Interviews happen during this time. Preferred dates are May 19 and 20. Please keep these dates free if possible.
...
The deadline to complete all of these is April 30, 18:00 UTC (for batch 2, 2026).
...
The interview and lead-up to the interview may contain components of the selection process that will be specific to the individual project.
The exact components of the interview process will be detailed in the email inviting you to the interview, after the first selection stage.
...
In the lead-up to the interview, further tasks may be requested of you that will take no longer than an estimated total of 8 hours to complete.

Before the interview:

- we may ask you to work on a mini-project no longer than an estimated 8 hours to complete, and submit your solution.
- we may ask you to participate in a pair programming session.

During the interview:

- we may ask you to give a short (5 to 10 minutes; to be finalised) presentation on a piece of Python code that you wrote. Please be ready to screen share your code or to send a link to the repo containing your code.
- we may ask you to participate in a pair programming session.
